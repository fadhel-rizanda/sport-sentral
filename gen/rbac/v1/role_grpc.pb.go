...
const (
	RoleService_GetRole_FullMethodName                  = "/rbac.v1.RoleService/GetRole"
	RoleService_CreateRole_FullMethodName               = "/rbac.v1.RoleService/CreateRole"
	RoleService_UpdateRole_FullMethodName               = "/rbac.v1.RoleService/UpdateRole"
	RoleService_DeleteRole_FullMethodName               = "/rbac.v1.RoleService/DeleteRole"
	RoleService_ListRoles_FullMethodName                = "/rbac.v1.RoleService/ListRoles"
	RoleService_AssignPermissionToRole_FullMethodName   = "/rbac.v1.RoleService/AssignPermissionToRole"
	RoleService_RevokePermissionFromRole_FullMethodName = "/rbac.v1.RoleService/RevokePermissionFromRole"
)
...
func (c *roleServiceClient) RevokePermissionFromRole(ctx context.Context, in *RevokePermissionFromRoleRequest, opts ...grpc.CallOption) (*RevokePermissionFromRoleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRoleServiceServer) RevokePermissionFromRole(context.Context, *RevokePermissionFromRoleRequest) (*RevokePermissionFromRoleResponse, error) {
...
func _RoleService_RevokePermissionFromRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).RevokePermissionFromRole(ctx, req.(*RevokePermissionFromRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rbac.v1.RoleService",
