...
func (c *tagServiceClient) GetTagByID(ctx context.Context, in *GetTagByIDRequest, opts ...grpc.CallOption) (*GetTagResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTagResponse)
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "meta.v1.TagService",
